...
**Левая панель**
- Навигация: Сетка, **Карта жизни** (вся жизнь на весь экран без прокрутки), Таймлайн, Статистика, Вехи, Цели, Паттерны, Сравнение, Заметки
...
Сайт статический и лежит в корне ветки `main`, поэтому его можно опубликовать
без сборки одним включением настройки:
...
> **https://flexiy0.github.io/LifeGrid/**

Каждый последующий `git push` в `main` будет автоматически обновлять страницу.
